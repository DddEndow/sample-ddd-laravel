...
class CreateOrderDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_details', function (Blueprint $table) {
            ...
            $table->string('order_detail_id', 30)->comment('発注明細ID');
            ...
            $table->primary(['order_id', 'order_detail_id']);
            $table->foreign('order_id', 'order_details-orders')->references('order_id')->on('orders');
